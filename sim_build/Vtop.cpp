...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , addr_valid{vlSymsp->TOP.addr_valid}
    , match{vlSymsp->TOP.match}
    , input_address{vlSymsp->TOP.input_address}
    , enables{vlSymsp->TOP.enables}
    , __PVT__bus_endpoint{vlSymsp->TOP.__PVT__bus_endpoint}
    , rootp{&(vlSymsp->TOP)}
{
...
VL_ATTR_COLD void Vtop::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP), name(), false, 23);

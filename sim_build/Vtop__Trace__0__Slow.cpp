...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__bus_endpoint__0(Vtop___024root* vlSelf, VerilatedVcd* tracep);
...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+2,0,"input_address",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBit(c+3,0,"addr_valid",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+4,0,"match",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declQuad(c+5,0,"enables",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 32,0);
    tracep->popPrefix();
    tracep->pushPrefix("address_decoder", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->pushPrefix("MODULE_CONFIG", VerilatedTracePrefixType::STRUCT_UNPACKED);
    tracep->declBus(c+7,0,"bus",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::INT, false,-1, 31,0);
    tracep->declBit(c+8,0,"burst",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__bus_endpoint__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop___024root__trace_init_sub__TOP__bus_endpoint__0\n"); );
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    const int c = vlSymsp->__Vm_baseCode;
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+2,(vlSelfRef.input_address),32);
    bufp->fullBit(oldp+3,(vlSelfRef.addr_valid));
    bufp->fullBit(oldp+4,(vlSelfRef.match));
    bufp->fullQData(oldp+5,(vlSelfRef.enables),33);
    bufp->fullIData(oldp+7,(vlSelfRef.address_decoder__DOT__MODULE_CONFIG
                            .__PVT__bus),32);
    bufp->fullBit(oldp+8,(vlSelfRef.address_decoder__DOT__MODULE_CONFIG
                          .__PVT__burst));
    bufp->fullBit(oldp+9,(vlSelfRef.address_decoder__DOT__MODULE_CONFIG
                          .__PVT__atomic));
    bufp->fullIData(oldp+10,(vlSelfRef.address_decoder__DOT__MODULE_CONFIG
